                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="grid gap-6">
                        {blogs.length === 0 ? (
                            ...
                            <article key={blog._id} className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl hover:border-slate-700 transition-all group">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex-1 min-w-0 pr-4">
                                        <h3 className="text-xl font-bold text-white mb-2 group-hover:text-teal-400 transition-colors">{blog.title}</h3>
